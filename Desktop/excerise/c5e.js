...
function greaterThan(n) {
 ...
 // console.log(greaterThan10(9));
  ...
  // → calling with [3, 2, 1] first the arugnments are passed then the funtion is passed
  ...
  // Filter method internal working
...
// Question 3 - Every with loop

function every(a, func){
  for(let i =0; i<a.length;i++){
    if(!func(a[i])) return false;
  }
  return true;
}
...
function every1(a, func){
  return !a.some(a => !func(a));
}
